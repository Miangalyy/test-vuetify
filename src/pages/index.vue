  ...
  <v-app id="home">
    ...
    <v-container fluid>
      <div class="head">
        <v-row>
          <v-col cols="5">
            <div class="mt-16" style="position: relative; text-align: center; display: flex; flex-direction: column;justify-content: center; align-items: center;">
          ...
          <v-col cols="2">
            ...
            text-align: center;"
             class="mt-16"
            >
              <v-icon>mdi mdi-arrow-down-drop-circle-outline</v-icon>
            </div>
          </v-col>
          <v-col cols="5">
            <div style="position: relative; z-index: 9999;" class="mt-16">
              <v-img src="/public/i1.png" contain max-height="300"></v-img>
            </div>
          </v-col>
        </v-row>
      </div>
      <v-col cols="12" class="mt-16" id="about">
        <div>
          <v-row>
            <v-col cols="12" sm="6">
              <div class="egg">
                <v-img src="/public/i2.png" max-height="300" class=""></v-img>
              </div>
            </v-col>
            <v-col cols="12" sm="6">
          ...
          <v-row>
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                <v-img src="/public/i10.jpg" height="200px" cover></v-img>
            ...
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                <v-img src="/public/i11.jpg" height="200px" cover></v-img>
            ...
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                <v-img src="/public/i12.jpg" height="200px" cover></v-img>
...
import AppFooterVue from '@/components/AppFooter.vue'
 ...
 // import DougNut from '@/components/DougNut.vue';
 //import BubBleVue from '@/components/BubBle.vue';
</script>
<script>
export default {
  data () {
